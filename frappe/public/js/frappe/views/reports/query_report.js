...
frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
	...
	pdf_report(print_settings) {
		...
		var party=[""];
		if(this.get_filter_values()["party"]){
			party = this.get_filter_values()["party"].join("_")+"_" || ""
		}
		print_settings.report_name = `${party}${__(this.report_name)}_${filter_values.join("_")}.pdf`;
